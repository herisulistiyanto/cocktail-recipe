 ...
 * may be used since `onCreate` up to `onDestroy` (inclusive)
 */
 ...
 * may be used since `onViewCreated` up to `onDestroyView` (inclusive)
 */
...
/**
 * DialogFragment binding delegate
 * implementing `onCreateDialog` (like Activities, they don't have separate view lifecycle)
 * may be use since `onCreateDialog` up to `onDestroy` (inclusive)
 */
...
/**
 * Not really a delegate, just helper function for RecyclerView.ViewHolders
 */
