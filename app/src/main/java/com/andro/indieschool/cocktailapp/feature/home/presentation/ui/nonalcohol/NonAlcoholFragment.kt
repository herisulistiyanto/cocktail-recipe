...
import com.andro.indieschool.cocktailapp.databinding.FragmentNonAlcoholBinding
...
class NonAlcoholFragment : Fragment(R.layout.fragment_non_alcohol) {

    private val binding by viewBinding(FragmentNonAlcoholBinding::bind)
    private val viewModel by viewModel<NonAlcoholViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.nonAlcoholState.collect { state ->
                when (state) {
    ...
    private fun setFlipperState(flipperState: HomeFlipperState) {
        binding.flipperNonAlcoholDrink.displayedChild = flipperState.state
    }

    companion object {
        fun newInstance(): NonAlcoholFragment {
            return NonAlcoholFragment()
        }
    }
}