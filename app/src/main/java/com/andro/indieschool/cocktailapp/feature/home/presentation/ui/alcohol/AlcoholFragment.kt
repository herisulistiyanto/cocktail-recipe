...
import com.andro.indieschool.cocktailapp.databinding.FragmentAlcoholBinding
...
class AlcoholFragment : Fragment(R.layout.fragment_alcohol) {
    ...
    private val binding by viewBinding(FragmentAlcoholBinding::bind)
    private val viewModel by viewModel<AlcoholViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.alcoholState.collect { state ->
                when (state) {
    ...
    private fun setFlipperState(flipperState: HomeFlipperState) {
        binding.flipperAlcoholDrink.displayedChild = flipperState.state
    }
